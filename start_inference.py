...
parser.add_argument('--save_path', type=str, default="/home/hiro/3d_tooth_seg/data/test_results/pointpp_dg_adv_3test", help = "result save directory.")
...
parser.add_argument('--checkpoint_path', default="/home/hiro/3d_tooth_seg/ckpts/pointnetpp_dg_test_adv_3_val" ,type=str,help = "checkpoint path.")
