...
parser.add_argument('--input_dir_path', type=str, default="/home/hiro/3d_tooth_seg/data/data_path", help = "input directory path that contain obj files.")
parser.add_argument('--split_txt_save_dir_path', type=str, default="/home/hiro/3d_tooth_seg/code/fold_path", help = "split txt path.")
